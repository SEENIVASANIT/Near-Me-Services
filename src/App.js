    ...
    <BrowserRouter>
      <div className="App">
        <Routes>
          ...
          <Route
            path="/admin_all_professions_show"
            element={<Admin_All_professions_show />}
          />
          {/* page1*/}
          ...
          <Route
            path="/input_for_work_type"
            element={<Input_for_work_type />}
          />
          ...
          <Route
            path="/Verificationid2FAtxNEstK1qemk1xgoZrU"
            element={<Verification_id />}
          />
        </Routes>
      </div>
    </BrowserRouter>
