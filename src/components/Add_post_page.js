    ...
    if (!update_id) {
      ...
      try {
        ...
        await addDoc(collection(db, commet_collections), {
          Post_id: localStorage.getItem("Access_id"),
          ...description_data,
    ...
    <div className="add_post_contianer">
      <div className="add_post_input_con">
        <div class="img_post_container">
          <div class="post_img_wrapper">
            ...
            <div class="insite_content">
              ...
              <div class="show_text_below_icon">No file chosen, yet!</div>
            </div>
            <div id="cancel-btn">
          ...
          <button id="custom-btn" onClick={() => select_img()}>
            Choose a file
          </button>
          <input
            id="default-btn"
        ...
        <span id="post-cancle-bttn-con">
          ...
          <span id="post-cancle-bttn-con-space" />
          <Button
